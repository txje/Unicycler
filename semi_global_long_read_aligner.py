...
def semi_global_align_long_reads(ref_fasta, long_reads_fastq, output_sam, temp_dir, graphmap_path,
    ...
    # graphmap_alignments = load_sam_alignments(graphmap_sam, reads, references)
...
# def load_sam_alignments(sam_filename, reads, references):
#     '''
...
#         line = line.strip()
#         if line:
#             paf_alignments.append(Alignment(reads, references, sam_line=line))
