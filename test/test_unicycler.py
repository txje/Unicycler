...
class TestAssemblyGraphFunctionsFastg(unittest.TestCase):
    ...
    def test_05000_bp_circular_no_repeat(self):
        for i in range(REPLICATE_COUNT):
            random.seed(i)
    ...
    def test_05000_bp_circular_one_repeat(self):
        for i in range(REPLICATE_COUNT):
            random.seed(i)
